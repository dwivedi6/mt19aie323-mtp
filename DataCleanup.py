...
sur2014 = pd.read_csv('datasets/survey2014.csv').assign(Year=2014)
sur2016 = pd.read_csv('datasets/survey2016.csv').assign(Year=2016)
sur2017 = pd.read_csv('datasets/survey2017.csv').assign(Year=2017)
sur2018 = pd.read_csv('datasets/survey2018.csv').assign(Year=2018)
sur2019 = pd.read_csv('datasets/survey2019.csv').assign(Year=2019)

sur141619 =  pd.concat([sur2014, sur2016, sur2019], ignore_index=True, sort=True)
sur1718 = pd.concat([sur2017, sur2018], ignore_index=True, sort=True)

survey = pd.concat([sur141619, sur1718], ignore_index=True, sort=True)
print(survey.shape)
...
survey.to_csv('cleanedDatasets/cleanedFinal.csv', index=False)
